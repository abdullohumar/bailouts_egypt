    ...
    >
        ...
        <div class="flex items-center gap-3 mb-5">
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-0.5">Personal source → auto <span class="text-orange-500 font-semibold">Pending</span> (Admin will settle)</p>
            </div>
        </div>
        ...
        @if($successMessage)
            <div class="mb-4 p-3 rounded-xl bg-green-50 border border-green-200 text-green-700
                ...
                Transaction saved! All members have been notified.
            </div>
        @endif
        ...
        <form wire:submit="save" class="space-y-4">
            ...
            {{-- Status — auto-set, read-only for personal --}}
            <div>
                <x-input-label for="tf_status" value="Status" />
                @if($source === 'personal')
                    {{-- Auto-locked to pending for personal bailouts --}}
                    <div class="mt-1 flex items-center gap-2 px-3 py-2.5 rounded-xl border border-yellow-300
                        ...
                        <span class="text-xs text-yellow-500 dark:text-yellow-500 ml-auto">Admin will settle this</span>
                    </div>
